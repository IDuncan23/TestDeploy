...
public class RequestDaoImpl implements RequestDao {
	...
	public boolean addExpenseRequest(int employeeId, String typeArg, String descArg, double amountArg) {
		...
		System.out.println("EmployeeId: " + employeeId + " Type: " + type + " Description: " + desc + " Amount: " + amountD2);
	...
	public List<Request> getResolvedRequests(int employeeId) {
		...
		try (Connection conn = ConnectionUtil.getConnection()){
			...
			System.out.println("RequestDaoImpl => getResolvedRequests(): Resolved Requests were selected!");
